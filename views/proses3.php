...
<ul class="nav nav-tabs">
  <li role="presentation"><a href="../proses">Data Caption</a></li>
  <li role="presentation"><a href="../proses2">Data Caption Topic 2</a></li>
  <li role="presentation" class="active"><a href="../proses3">Data Caption Topic 3</a></li>
    ...
    <div class="col-xs-12 col-md-12">
        <div class="panel panel-primary">   
            <div  class="panel-heading"> Data Caption User
                ...
                <a href="../makemodel3" class="btn btn-default btn-xs" style="margin-left: 5px;">Make Model</a>
                <a href="../clasify3" class="btn btn-default btn-xs" style="margin-left: 5px;">Classify Data</a></div>
            <table id="myScrollTable" class="table table-hover" style="margin-bottom: 3px;">
               ...
               <?php 
                ...
                <?php 
                $db->pfx="";
                $f = $db->r( 'caption_bot c, username u, periode p, cluster_3 t', 'id,pesan,gender,waktu, month, year,topik', 'where u.username = c.oleh and c.id = p.id_timepost and c.id=t.id_caption' ); ?>
