						...
						$(function () {
							$('#container').highcharts({
								...
								<?php
									...
									$SP = [0,1];	
									$SU = [0,1];	
									$f2 = $db->r( 'sekolah s, region r, caption_bot c, username u, cluster_4 l', 'count(id) as n, region, topik', 'where c.oleh = u.username and c.id = l.id_caption and u.kode_sekolah=s.id_sekolah and r.id_region=s.region group by topik, region');
