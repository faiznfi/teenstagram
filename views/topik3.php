...
<ul class="nav nav-tabs">
  ...
  <li role="presentation" class="active"><a href="../topik2">Topic by Gender</a></li>
						...
						$(function () {
							$('#container').highcharts({
								...
								<?php
									...
									$cwo = [0,1];	
									$cwe = [0,1];	
									$f2 = $db->r( 'caption_bot c, username u, cluster_3 l', 'count(id) as n, gender, topik', 'where c.oleh = u.username and c.id = l.id_caption group by topik, gender');
									foreach ($f2 as $r2) {
