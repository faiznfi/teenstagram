...
<html>
				...
				<head>
					...
					<div class="btn-group" role="group" aria-label="...">
					  ...
					  <button type="button" class="btn btn-default"><a href="../topik5">5 Topik</button
						...
						$(function () {
							$('#container').highcharts({
								...
								<?php
									...
									$cwo = [0,1];	
									$cwe = [0,1];	
									$f2 = $db->r( 'caption_bot c, username u, cluster_5 l', 'count(id) as n, gender, topik', 'where c.oleh = u.username and c.id = l.id_caption group by topik, gender');
									foreach ($f2 as $r2) {
