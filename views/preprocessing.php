...
<ul class="nav nav-tabs">
  <li role="presentation"><a href="../proses">Data Caption Topic 2</a></li>
  <li role="presentation"><a href="../proses">Data Caption Topic 3</a></li>
  <li role="presentation"><a href="../proses">Data Caption Topic 4</a></li>
  <li role="presentation"><a href="../proses">Data Caption Topic 5</a></li>
  <li role="presentation" class="active"><a href="../preprocessing">Modeling Data</a></li>
  <!-- <li role="presentation"><a href="../region">Lorem</a></li> -->
    ...
    <div class="col-xs-12 col-md-12">
        <div class="panel panel-primary">   
            <div  class="panel-heading"> Data Caption User
                <a href="../runprepro" class="btn btn-default btn-xs" style="margin-left: 675px;">Preproses Data</a>
                <a href="../makemodel" class="btn btn-default btn-xs" style="margin-left: 5px;">Make Model</a>
                <a href="../clasify2" class="btn btn-default btn-xs" style="margin-left: 5px;">Classify Data</a></div>
            <br>    
         ...
         <?php 
                ...
                <?php 
                $db->pfx="";
                $f = $db->r( 'caption_bot c, username u, periode p', 'id,pesan,gender,waktu, month, year', 'where u.username = c.oleh and c.id = p.id_timepost' ); ?>
