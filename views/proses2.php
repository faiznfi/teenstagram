...
<ul class="nav nav-tabs">
  ...
  <li role="presentation" class="active"><a href="../proses2">Data Caption Topic 2</a></li>
    ...
    <div class="col-xs-12 col-md-12">
        <div class="panel panel-primary">   
           <div  class="panel-heading"> Data Caption User
                ...
                <a href="../makemodel2" class="btn btn-default btn-xs" style="margin-left: 5px;">Make Model</a>
