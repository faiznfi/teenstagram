...
<html>
				...
				<head>
					...
					<div class="btn-group" role="group" aria-label="...">
					  <button type="button" class="btn btn-default"><a href="../region2">2 Topik</button></a>
					  <button type="button" class="btn btn-default"><a href="../region3">3 Topik</button></a>
					  <button type="button" class="btn btn-default"><a href="../region4">4 Topik</button></a>
					  <button type="button" class="btn btn-default"><a href="../region5">5 Topik</button></a>
						...
						$(function () {
							$('#container').highcharts({
								...
								<?php
									...
									$SP = [0,1];	
									$SU = [0,1];	
									$f2 = $db->r( 'sekolah s, region r, caption_bot c, username u, cluster_3 l', 'count(id) as n, region, topik', 'where c.oleh = u.username and c.id = l.id_caption and u.kode_sekolah=s.id_sekolah and r.id_region=s.region group by topik, region');
