						...
						$(function () {
							$('#container').highcharts({
								...
								<?php
									...
									$f2 = $db->r( 'caption_bot c, username u, cluster_3 l, periode p', 'count(id) as n, month, year,topik', 'where year = 17 and c.oleh = u.username and c.id = l.id_caption and p.id_timepost=c.id group by topik, year, month');
									foreach ($f2 as $r2) {
